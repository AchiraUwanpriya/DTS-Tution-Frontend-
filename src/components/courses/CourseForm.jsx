...
//       list = initialData.subjects.map((s) => ({
//         id: s.id ?? null,
...
//           setStoredTeacher({ id: parsed.id ?? String(parsed.id), name: parsed.name ?? "" });
//         }
//       }
//     } catch (e) {
//       // ignore
...
//         let rawTeacher = data.teacherId ?? data.teacherID ?? data.TeacherID ?? "";
//         let teacherId = "";
//         if (rawTeacher) {
//           teacherId = rawTeacher;
//         } else {
//           try {
//             const stored = window.localStorage.getItem("selected_teacher_for_course");
//             if (stored) {
//               try {
...
//           control={control}
//           render={({ field }) => {
//             const displayed = (field.value && String(field.value).trim()) || autoGeneratedCode || "";
//             return (
//               <input
//                 disabled
//                 id="code"
...
//                       type="button"
//                       onClick={() => {
//                         const next = (selectedSubjects || []).filter((_, i) => i !== idx);
...
//                             setValue("subjectId", first.id, { shouldDirty: true, shouldValidate: true });
//                           } else {
//                             setValue("subjectId", "", { shouldDirty: true, shouldValidate: true });
//                           }
//                         } catch (err) {
//                           // ignore
//                         }
